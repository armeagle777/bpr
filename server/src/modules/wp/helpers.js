const getWpQuery = (pnum) => `SELECT
                ...
                FROM
                users a
                    INNER JOIN employees b ON a.id = b.user_id
                    INNER JOIN claims c ON b.id = c.employee_id
                    LEFT JOIN
                    ...
                    INNER join vacancies e on c.vacancy_id = e.id
                    INNER join  position_codes g on e.position_code_id = g.id
                    INNER join companies h on e.company_id = h.id
                WHERE
                    a.ssn =${pnum} 
